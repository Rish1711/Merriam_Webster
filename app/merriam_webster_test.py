...
def test_fetch_definition():
    ...
    assert test_client.fetch_definition("hospital") == "hospital (noun): a charitable institution for the needy, aged, infirm, or young"
...
if __name__ == "__main__":
    ...
    logging.info("Starting tests for MerriamWebsterAPI.fetch_definition method")
